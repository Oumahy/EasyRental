						...
						<li class="has-sub">
								...
								<ul class="sub-menu" id="vendors" data-parent="#sidebar-menu">
									<li>
										<a class="sidenav-item-link" href="vendor-card.html">
											<span class="nav-text">Grille des fournisseurs</span>
										</a>
									</li>
									<li>
									...
									<ul class="sub-menu" id="users" data-parent="#sidebar-menu">
										<li class="active">
											<a class="sidenav-item-link" href="user-card.html">
												<span class="nav-text">Grille utilisateur</span>
											</a>
										</li>
										<li>
											<a class="sidenav-item-link" href="user-list.html">
												<span class="nav-text">liste d'utilisateur</span>

											</a>
										</li>
										<li>
											<a class="sidenav-item-link" href="user-profile.html">
												<span class="nav-text">Profil des utilisateurs</span>
											</a>
										</li>
									</ul>
								</div>
							...
							<li class="has-sub">
								<a class="sidenav-item-link" href="javascript:void(0)">
									...
									<span class="nav-text">Des produits</span>
									<b class="caret"></b>
								</a>
								<div class="collapse">
																	...
																	<a href="javascript:0" class="media text-secondary">
																		...
																		<div class="media-body">
																			...
																			<ul class="list-unstyled">
																				...
																				<li class="d-flex mb-1">
																					<i class="mdi mdi-phone mr-1"></i> <span>(+212) 888 777 632</span>
																				</li>
																			</ul>
																		</div>
																	</a>
