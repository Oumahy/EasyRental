...
<div id="forgotpassword" class="modal fade">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Retrouvez votre compte </h5>
        ...
        <div class="login_wrap">
          <div class="col-md-12 col-sm-6">
           <form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <input type="text" name="mobile" class="form-control" placeholder="Numero*" required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <input type="submit" value="Réinitialiser mon mot de passe" name="update" class="btn btn-block" style="background-color: #49a3ff;">
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="modal-footer ">
    <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Vous avez déjà un compte ?</a></p>
  </div>
  <!-- /.modal-content -->
</div>
