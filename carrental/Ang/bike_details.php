...
<head>
  <meta charset="utf-8">
  <title>Car Rental|Bike Details</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>ABOUT Bike</span><br>We provide high quality and well serviced Bikes </h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
          ...
          <section class="listing-detail">
            <div class="container">
              <div class="listing_detail_head row">
                <div class="col-md-9">
                  <h2> <?php echo htmlentities($result->BikeTitle);?>  Bike</h2>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="listing_more_info">
                    <div class="listing_detail_wrap"> 
                      ...
                      <ul class="nav nav-tabs gray-bg" role="tablist">
                        <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" style="background-color: #49a3ff;" data-toggle="tab">Bike Overview </a></li>
