...
<head>
  <meta charset="utf-8">
  <title>EasyRental | Détails de la voiture</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>À PROPOS DE LA VOITURE</span><br>Nous fournissons des voitures de haute qualité et bien entretenues</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
                  ...
                  <div class="listing_more_info">
                    <div class="listing_detail_wrap"> 
                      ...
                      <ul class="nav nav-tabs gray-bg" role="tablist">
                        <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" style="background-color: #49a3ff;" data-toggle="tab">Présentation du véhicule</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane" id="accessories"> 
                          ...
                          <table>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>Verrouillage électrique des portières</td>
            ...
            <div class="sidebar_widget">
              ...
              <form method="post">
                ...
                {?>
                  ...
                  <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal" style="background-color: #49a3ff;">Se connecter pour réserver</a>
                  ...
                  <div class="product-listing-m gray-bg">
                    ...
                    <div class="product-listing-content">
                      ...
                      <ul class="features_list">
                       ...
                       <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> modele<e/li>
